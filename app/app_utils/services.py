...
def get_memory_service():
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-f41b114e9e04")
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", "5136410350597439488")
    location = (
